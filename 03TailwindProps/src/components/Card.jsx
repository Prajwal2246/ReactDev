...
function Card({name="name",info="info"}) {
  return (
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl m-4  bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
      <div className="relative overflow-hidden rounded-lg mb-6">
        <img
          ...
          width={400}
          height={300}
          className="object-cover object-center w-100 h-58  transition-transform duration-300 group-hover:scale-110"
        />
